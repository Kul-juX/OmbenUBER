...
function initMap() {
    ...
    fetch('https://ipapi.co/json/') // Replace with a reliable IP geolocation API
...
// JavaScript to redirect to another page on button click
document.getElementById("myButton").addEventListener("click", function () {
  window.location.href = "location.html"; // Replace with your target page's URL
});
